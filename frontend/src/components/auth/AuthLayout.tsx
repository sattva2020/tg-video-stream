...
const AuthLayout: React.FC<AuthLayoutProps> = ({ hero, primary, secondary }) => (
  <section
    ...
    className="relative z-10 mx-auto flex min-h-screen w-full max-w-screen-xl flex-col justify-center px-4 py-10 md:px-6 xl:px-10"
  >
    ...
    {secondary ? (
      <div className="grid auto-rows-max gap-8 md:grid-cols-[minmax(0,1fr)_minmax(320px,420px)] md:items-start xl:grid-cols-[minmax(0,0.85fr)_minmax(360px,480px)] xl:gap-12">
