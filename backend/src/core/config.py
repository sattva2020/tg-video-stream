...
class Settings:
    ...
    ADAPTIVE_STREAMING_ENABLED: bool = os.getenv("ADAPTIVE_STREAMING_ENABLED", "true").lower() == "true"
    ADAPTIVE_DEFAULT_QUALITY: str = os.getenv("ADAPTIVE_DEFAULT_QUALITY", "high")
    ADAPTIVE_MIN_QUALITY: str = os.getenv("ADAPTIVE_MIN_QUALITY", "low")
    ADAPTIVE_MAX_QUALITY: str = os.getenv("ADAPTIVE_MAX_QUALITY", "ultra")
    ADAPTIVE_BANDWIDTH_THRESHOLD_LOW_KBPS: int = int(os.getenv("ADAPTIVE_BANDWIDTH_THRESHOLD_LOW_KBPS", "500"))
    ADAPTIVE_BANDWIDTH_THRESHOLD_MEDIUM_KBPS: int = int(os.getenv("ADAPTIVE_BANDWIDTH_THRESHOLD_MEDIUM_KBPS", "1500"))
    ADAPTIVE_BANDWIDTH_THRESHOLD_HIGH_KBPS: int = int(os.getenv("ADAPTIVE_BANDWIDTH_THRESHOLD_HIGH_KBPS", "3000"))
    ADAPTIVE_BANDWIDTH_THRESHOLD_ULTRA_KBPS: int = int(os.getenv("ADAPTIVE_BANDWIDTH_THRESHOLD_ULTRA_KBPS", "6000"))
    ADAPTIVE_ADAPTATION_INTERVAL_SECONDS: int = int(os.getenv("ADAPTIVE_ADAPTATION_INTERVAL_SECONDS", "30"))
    ADAPTIVE_BANDWIDTH_SMOOTHING_FACTOR: float = float(os.getenv("ADAPTIVE_BANDWIDTH_SMOOTHING_FACTOR", "0.3"))
    ADAPTIVE_CONSECUTIVE_MEASUREMENTS_REQUIRED: int = int(os.getenv("ADAPTIVE_CONSECUTIVE_MEASUREMENTS_REQUIRED", "3"))
    ADAPTIVE_ENABLE_BANDWIDTH_MONITORING: bool = os.getenv("ADAPTIVE_ENABLE_BANDWIDTH_MONITORING", "true").lower() == "true"
    ADAPTIVE_ENABLE_QUALITY_LOGGING: bool = os.getenv("ADAPTIVE_ENABLE_QUALITY_LOGGING", "true").lower() == "true"
    ADAPTIVE_MOBILE_OPTIMIZATION_ENABLED: bool = os.getenv("ADAPTIVE_MOBILE_OPTIMIZATION_ENABLED", "true").lower() == "true"
    ADAPTIVE_MOBILE_BANDWIDTH_MULTIPLIER: float = float(os.getenv("ADAPTIVE_MOBILE_BANDWIDTH_MULTIPLIER", "0.7"))
