...
#### [FRONTEND_SCHEDULE_SOFT_OUTLINES_FIX.md](FRONTEND_SCHEDULE_SOFT_OUTLINES_FIX.md)
**Дата:** 20 декабря 2025  
**Статус:** ✅ Исправлено, задеплоено и протестировано  
**Проблема:** На `/schedule` в тёмной теме было слишком много вложенных контуров (`border + ring`), а сетка календаря выглядела слишком «жёстко».  
