...
## Возможности
- Крутит **YouTube-плейлист** по кругу (файл `playlist.txt`).
...
sudo cp -r ./tg_video_streamer_v1/* /opt/tg_video_streamer/
...
## Плейлист
Файл `playlist.txt` — по одной ссылке на строку:
```
...
```bash
sudo cp tg_video_streamer.service /etc/systemd/system/tg_video_streamer.service
...
## Управление
- Обновить плейлист: отредактируйте `playlist.txt` — сервис подхватит новый список на следующей итерации.
